...
#It is very hard to see, but the priors looks like it fits decently.
```
...
plot(new_m1, N=1)
# The chains generally look good, they are even and well mixed. However, the plot for sd_Language_Intercept and sigma are a bit off, but they are not too bad.
```
...
#  ?? Do we need to do that here - It is in the bayesian workflowm but he doesn't specify it in this task ??
```
